...
<div class="terms-of-service">
	<h1>TERMS OF SERVICE OVERVIEW</h1>
	<h2>This website is operated by UTTARMANTR EDSOLUTION (OPC) PVT. LTD.</h2>
	<p>
		Throughout the site, the terms <b>“we”</b>, <b>“us”</b> and <b>“our”</b> refer to
		<b>UTTARMANTR EDSOLUTION (OPC) PVT. LTD.</b>
		<b>UTTARMANTR EDSOLUTION (OPC) PVT. LTD (UnlockMains)</b> offers this website, including all information,
		tools and services available from this site to you, the user, conditioned upon your acceptance of
		all terms, conditions, policies and notices stated here. By visiting our site and/ or purchasing
		...
		content. Please read these Terms of Service carefully before accessing or using our website. By accessing
		...
		Terms of Service. Any new features or tools which are added to the current store shall also be subject
		to the Terms of Service. You can review the most current version of the Terms of Service at any time
		on this page. We reserve the right to update, change or replace any part of these Terms of Service
		by posting updates and/or changes to our website. It is your responsibility to check this page periodically
		for changes. Your continued use of or access to the website following the posting of any changes
		constitutes acceptance of those changes.
	</p>
	<h4>ANNEXURE 1 - ONLINE STORE TERMS</h4>
	<p>
		...
		nature. A breach or violation of any of the Terms will result in an immediate termination of
		your Services.
	</p>
	<h4>ANNEXURE 2 - GENERAL CONDITIONS</h4>
	<p>
	...
	<h4>ANNEXURE 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h4>
	<p>
	...
	<h4>ANNEXURE 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h4>
	<p>
	...
	<h4>ANNEXURE 5 - PRODUCTS OR SERVICES</h4>
	<p>
	...
	<h4>ANNEXURE 6 - BILLING AND ACCOUNT INFORMATION</h4>
	<p>
		...
		that we can complete your transactions and contact you as needed. For more detail, please review
		our Returns Policy.
	</p>
	<h4>ANNEXURE 7 - THIRD PARTY TOOLS</h4>
	<p>
		...
		optional third-party tools. Any use by you of third party tools offered through the site is
	...
	<h4>ANNEXURE 8 - THIRD-PARTY LINKS</h4>
	<p>
	...
	<h4>ANNEXURE 9 - USER FEEDBACK, COMMENTS AND OTHER SUBMISSIONS</h4>
	<p>
	...
	<h4>ANNEXURE 12 - PROHIBITED USES</h4>
	<p>
	...
	<h4>ANNEXURE 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h4>
	<p>
		...
		particular purpose, durability, title, and non-infringement. In no case shall UTTARMANTR
		EDSOLUTION (OPC) PVT. LTD, our directors, officers, employees, affiliates, agents, contractors,
	...
	<h4>ANNEXURE 14 - INDEMNIFICATION</h4>
	<p>
		You agree to indemnify, defend and hold harmless UTTARMANTR EDSOLUTION (OPC) PVT. LTD and our
	...
	<h4>ANNEXURE 15 - REFUND POLICY</h4>
	Follow {' '} <a href="/quick-links/refund-policy">this link</a> to read the REFUND POLICY.
	<h4>ANNEXURE 16 - SEVERABILITY</h4>
	<p>
	...
	<h4>ANNEXURE 18 - ENTIRE AGREEMENT</h4>
	<p>
	...
	<h4>ANNEXURE 19 - GOVERNING LAW</h4>
	<p>
		These Terms of Service and any separate agreements whereby we provide you Services shall be
		governed by and construed in accordance with the laws of India and jurisdiction of Palam,
		DELHI-110077
	</p>
	<h4>ANNEXURE 20 - CHANGES TO TERMS OF SERVICE</h4>
	<p>
	...
	<h4>ANNEXURE 21 - CONTACT INFORMATION</h4>
	<p>
		Questions about the Terms of Service should be sent to us at UnlockMains on <a
			href="mailto:unlockmains@gmail.com">unlockmains@gmail.com</a
		>
	</p>
</div>
<HomeFooter />
