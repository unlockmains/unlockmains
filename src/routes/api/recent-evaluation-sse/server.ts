...
export const getRecentEvaluations = async (databases: Databases, userId: string, onlyCompleted: boolean = true) => {
    ...
    const submissions = await databases.listDocuments(PUBLIC_APPWRITE_DATABASE, PUBLIC_APPWRITE_STUDENT_SUBMISSION_DB, [
        ...
        ...onlyCompleted ? [Query.equal('status', [ESubmissionStatus.EVALUATED, ESubmissionStatus.COMPLETED])] : [],
